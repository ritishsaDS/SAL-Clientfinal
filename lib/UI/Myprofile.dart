                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10,),
                              Center(
                                child: Text("Suman Aggarwal"   ,style: GoogleFonts.openSans(
                                color: Color(backgroundColorBlue),
...
Container(
  ...
  child: Column(
    ...
    Text("Date Of Birth",style: GoogleFonts.openSans(
        ...
        fontSize: SizeConfig.blockSizeVertical *
            1.75),),
    Text("23/12/1999",style: GoogleFonts.openSans(
        color: Colors.black,
        fontWeight: FontWeight.w600,
        fontSize: SizeConfig.blockSizeVertical *
            1.90),),
    ...
    Text("Phone Number",style: GoogleFonts.openSans(
        ...
        fontSize: SizeConfig.blockSizeVertical *
            1.75),),
    Text(mobileController.text,style: GoogleFonts.openSans(
        color: Colors.black,
        fontWeight: FontWeight.w600,
        fontSize: SizeConfig.blockSizeVertical *
            1.90),),
      ...
      Text("Email",style: GoogleFonts.openSans(
        ...
        fontSize: SizeConfig.blockSizeVertical *
            1.75),),
    Text("ritishs39@gmail.com",style: GoogleFonts.openSans(
        color: Colors.black,
        fontWeight: FontWeight.w600,
        fontSize: SizeConfig.blockSizeVertical *
            1.90),),
                                          ...
                                          child: GridView.builder(
                                            physics: NeverScrollableScrollPhysics(),
                                              ...
                                              itemBuilder: (BuildContext ctx, index) {
                                                return Container(
                                                  alignment: Alignment.center,
                                                  child: Text(list[index],style: GoogleFonts.openSans(
                                                  color: Color(fontColorSteelGrey),
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: SizeConfig.blockSizeVertical *
                                                      1.90),),
