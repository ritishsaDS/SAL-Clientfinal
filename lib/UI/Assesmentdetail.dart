...
import 'package:sal_user/models/get_assessment_que_response_model.dart';
...
class _AssesmantState extends State<AssesmantDetail> {
  ...
  Future<void> postAssessment(List<Map<String, String>> detail) async {
    ...
    String url =
        'https://yvsdncrpod.execute-api.ap-south-1.amazonaws.com/prod/client/assessment';
    print('URL : $url');
  ...
  Future<void> getAssessmentQuestion() async {
    ...
    try {
      ...
      String clientId = pref.getString('cleintid');
      final String url =
          'https://yvsdncrpod.execute-api.ap-south-1.amazonaws.com/prod/client/assessment?assessment_id=${widget.id}';
      print('URL:$url');
      print('Client ID :$clientId');
