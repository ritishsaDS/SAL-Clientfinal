...
class _RescheduleAppointmentState extends State<RescheduleAppointment> {
              ...
              Container(
                ...
                child: MaterialButton(
                  onPressed: () async {
                    ...
                    Reschedulebooking.diomwthod(widget.appointment,slotid, selectdate.toString(),
                        widget.data, "1", context);
                    // }else{
  ...
  void getdatafromserver() async {
    ...
    setState(() {
      isLoading = true;
      if(widget.id==null){
        url='https://yvsdncrpod.execute-api.ap-south-1.amazonaws.com/prod/client/counsellor/slots?counsellor_id=${widget.data['id']}';
      }
      else{
        url="https://yvsdncrpod.execute-api.ap-south-1.amazonaws.com/prod/client/counsellor/slots?counsellor_id=${widget.id}";
      }
    });
  ...
  void BookanAppointment() async {
    ...
    setState(() {
      isLoading = true;
        ...
        url="https://yvsdncrpod.execute-api.ap-south-1.amazonaws.com/prod/client/appointment?appointment_id=${widget.appointment}";
