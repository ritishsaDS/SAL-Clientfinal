...
GetAssessmentsResultResponseModel getAssessmentsResultResponseModelFromJson(String str) => GetAssessmentsResultResponseModel.fromJson(json.decode(str));

String getAssessmentsResultResponseModelToJson(GetAssessmentsResultResponseModel data) => json.encode(data.toJson());
...
class GetAssessmentsResultResponseModel {
  ...
  factory GetAssessmentsResultResponseModel.fromJson(Map<String, dynamic> json) => GetAssessmentsResultResponseModel(
